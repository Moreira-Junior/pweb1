class ContaController {
    ...
    inserir(evento) {
        ...
        const elementoAniversario = document.querySelector('#aniversario');
        ...
        switch (elementoTipoConta.value) {
            case 'conta':
                conta = new Conta(elementoNumero.value,
                    ...
                    break;
            case 'poupanca':
                conta = new Poupanca(elementoNumero.value, Number(elementoSaldo.value), elementoAniversario.value);
                break;
            case 'bonificada':
    ...
    inserirContaNoHTML(conta) {
        ...
        if (conta.dataAniversario){
            elementoP.append(' Aniversario: ' + conta.dataAniversario)
        }
